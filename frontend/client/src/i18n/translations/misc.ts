...
export const en: Record<string, string> = {
  ...
  'misc.accounts.paid': 'Paid',
  'misc.accounts.settlesCharge': 'Settles which charge',
  'misc.accounts.onAccount': 'On account (not applied to a month)',
  'misc.accounts.outstanding': 'outstanding',
  'misc.accounts.settled': 'settled',
  'misc.accounts.noUnpaidCharges': 'No unpaid charges — this payment will sit on the account.',
...
export const ar: Record<string, string> = {
  ...
  'misc.accounts.paid': 'مسدّد',
  'misc.accounts.settlesCharge': 'يسدد أي رسم',
  'misc.accounts.onAccount': 'على الحساب (غير مخصص لشهر)',
  'misc.accounts.outstanding': 'متبقٍ',
  'misc.accounts.settled': 'سدّد',
  'misc.accounts.noUnpaidCharges': 'لا توجد رسوم غير مسددة — ستُسجّل هذه الدفعة على الحساب.',
