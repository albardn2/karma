...
export const en: Record<string, string> = {
  ...
  'warehouses.currentInventory': 'Current Inventory',
  'warehouses.inventoryOverTime': 'Inventory Over Time',
  'warehouses.quantity': 'Quantity',
  'warehouses.unit': 'Unit',
  'warehouses.lots': 'Lots',
  'warehouses.lastMovement': 'Last Movement',
  'warehouses.noInventory': 'No inventory in this warehouse',
  'warehouses.topMaterialsNote': 'Showing the material with the most stock — pick materials to chart others or compare.',
  'warehouses.perMaterialNote': 'One line per material — note each material has its own unit and scale.',
  'warehouses.addInventory': 'Add Inventory',
  'warehouses.stockAdded': 'Inventory added to this warehouse',
  'warehouses.addStockFailed': 'Failed to add inventory',
  'warehouses.quantityPositive': 'Quantity must be greater than zero',
  'warehouses.costPerUnitOptional': 'Cost per Unit (Optional)',
  'warehouses.currencyRequiredWithCost': 'Required when a cost is set',
  'warehouses.lotAutoGenerated': 'Auto-generated if empty',
  'warehouses.manualAddNote': 'This creates a new lot with the quantity you enter, recorded as a manual inventory event.',
};
...
export const ar: Record<string, string> = {
  ...
  'warehouses.currentInventory': 'المخزون الحالي',
  'warehouses.inventoryOverTime': 'المخزون عبر الزمن',
  'warehouses.quantity': 'الكمية',
  'warehouses.unit': 'الوحدة',
  'warehouses.lots': 'الدفعات',
  'warehouses.lastMovement': 'آخر حركة',
  'warehouses.noInventory': 'لا يوجد مخزون في هذا المستودع',
  'warehouses.topMaterialsNote': 'يتم عرض المادة الأكثر مخزوناً — اختر مواد لعرض غيرها أو للمقارنة.',
  'warehouses.perMaterialNote': 'خط لكل مادة؛ كل منها بوحدته الخاصة.',
  'warehouses.addInventory': 'إضافة مخزون',
  'warehouses.stockAdded': 'تمت إضافة المخزون إلى هذا المستودع',
  'warehouses.addStockFailed': 'فشل في إضافة المخزون',
  'warehouses.quantityPositive': 'يجب أن تكون الكمية أكبر من صفر',
  'warehouses.costPerUnitOptional': 'التكلفة لكل وحدة (اختياري)',
  'warehouses.currencyRequiredWithCost': 'مطلوبة عند إدخال التكلفة',
  'warehouses.lotAutoGenerated': 'يتم إنشاؤه تلقائياً إذا تُرك فارغاً',
  'warehouses.manualAddNote': 'يؤدي هذا إلى إنشاء دفعة جديدة بالكمية المدخلة، مسجلة كحركة مخزون يدوية.',
};
