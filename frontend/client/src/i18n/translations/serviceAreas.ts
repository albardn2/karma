...
export const en: Record<string, string> = {
  ...
  'serviceAreas.toggleCustomers': 'Customers',
  'serviceAreas.toggleCustomersHint': 'Show or hide customer locations in view',
  'serviceAreas.toggleAreas': 'Existing areas',
  'serviceAreas.toggleAreasHint': 'Show or hide service areas that already exist',
  'serviceAreas.overlayCustomer': 'Customer',
  'serviceAreas.overlayCustomersHere': '{count} customers here',
  'serviceAreas.overlayLoadFailed': "Couldn't load map layer",
  'serviceAreas.editShape': 'Edit shape',
  'serviceAreas.editingArea': 'Editing: {name}',
  'serviceAreas.saveShape': 'Save shape',
  'serviceAreas.cancelEdit': 'Cancel',
  'serviceAreas.discardChanges': 'Discard changes',
  'serviceAreas.discardChangesBody': 'The boundary you redrew has not been saved. Discard it?',
  'serviceAreas.listPausedWhileEditing': 'Area list paused while editing',
  'serviceAreas.saveShapeSuccess': 'Boundary updated',
  'serviceAreas.saveShapeError': 'Could not save the boundary',
  'serviceAreas.noLongerPermitted': 'You no longer have permission to save this. Copy the shape before leaving.',
  'serviceAreas.geometryNotEditable': 'This boundary cannot be edited on the map — open the area and redraw it.',
  'serviceAreas.createSubtitle': 'Draw the boundary on the map, then name it',
  'serviceAreas.noPolygonYet': 'No polygon drawn yet — use the polygon tool on the map',
  'serviceAreas.createError': 'Failed to create service area',
...
export const ar: Record<string, string> = {
  ...
  'serviceAreas.toggleCustomers': 'العملاء',
  'serviceAreas.toggleCustomersHint': 'إظهار أو إخفاء مواقع العملاء في النطاق المعروض',
  'serviceAreas.toggleAreas': 'المناطق الحالية',
  'serviceAreas.toggleAreasHint': 'إظهار أو إخفاء مناطق الخدمة الموجودة بالفعل',
  'serviceAreas.overlayCustomer': 'عميل',
  'serviceAreas.overlayCustomersHere': '{count} عملاء هنا',
  'serviceAreas.overlayLoadFailed': 'تعذّر تحميل طبقة الخريطة',
  'serviceAreas.editShape': 'تعديل الشكل',
  'serviceAreas.editingArea': 'جارٍ التعديل: {name}',
  'serviceAreas.saveShape': 'حفظ الشكل',
  'serviceAreas.cancelEdit': 'إلغاء',
  'serviceAreas.discardChanges': 'تجاهل التغييرات',
  'serviceAreas.discardChangesBody': 'الحدود التي رسمتها لم تُحفظ. هل تريد تجاهلها؟',
  'serviceAreas.listPausedWhileEditing': 'قائمة المناطق متوقفة أثناء التعديل',
  'serviceAreas.saveShapeSuccess': 'تم تحديث الحدود',
  'serviceAreas.saveShapeError': 'تعذّر حفظ الحدود',
  'serviceAreas.noLongerPermitted': 'لم تعد تملك صلاحية الحفظ. انسخ الشكل قبل الخروج.',
  'serviceAreas.geometryNotEditable': 'لا يمكن تعديل هذه الحدود على الخريطة — افتح المنطقة وأعد رسمها.',
  'serviceAreas.createSubtitle': 'ارسم الحدود على الخريطة ثم أدخل الاسم',
  'serviceAreas.noPolygonYet': 'لم يتم رسم أي مضلع بعد — استخدم أداة المضلع على الخريطة',
  'serviceAreas.createError': 'فشل إنشاء منطقة الخدمة',
