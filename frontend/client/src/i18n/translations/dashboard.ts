...
export const en: Record<string, string> = {
  ...
  'dashboards.materialProfitability': 'Profitability per Material',
  'dashboards.materialProfitabilityDesc': 'Revenue, cost and gross margin per material, company-wide.',
...
export const ar: Record<string, string> = {
  ...
  'dashboards.materialProfitability': 'الربحية لكل مادة',
  'dashboards.materialProfitabilityDesc': 'الإيرادات والتكلفة والهامش الإجمالي لكل مادة، على مستوى الشركة.',
