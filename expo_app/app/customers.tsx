...
import { StyleSheet, ScrollView, TouchableOpacity, TextInput, Alert, ActivityIndicator, Platform, Dimensions, Animated, Modal, RefreshControl } from 'react-native';
...
export default function CustomersScreen() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      // Clear search and filters for fresh data
      setSearchTerm('');
          ...
          <View style={{ flex: 1 }}>
            <ScrollView
              ...
              contentContainerStyle={[
                ...
                isMobileWeb && { paddingBottom: 100 }, // Extra padding for mobile web to clear bottom nav
                isNative && { paddingBottom: 100 } // Extra padding for native to clear bottom nav
              ]}
